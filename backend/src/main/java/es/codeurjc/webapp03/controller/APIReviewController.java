...
public class APIReviewController {
    ...
    @PostMapping("/api/book/{id}/addReview") // return the added review as a JSON
    ...
    // Delete review
    @DeleteMapping("/api/deleteReview/{reviewID}") // return a message stating that the review was deleted
